...
connect.then((db) => {
    console.log("You have Connected correctly to server congrats heres a cookie");
}, (err) => { console.log(err); });
...
app.use('/Phones', PhoneRouter); //use the Phone router when there is a request at localhost:3000/Phone
